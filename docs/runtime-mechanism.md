...
本文是运行机制导读；权威约束见 [`ARCHITECTURE.md`](./ARCHITECTURE.md)，执行改造见 [`2026-08-09-multi-agent-review-v2-hard-cut.md`](./superpowers/plans/2026-08-09-multi-agent-review-v2-hard-cut.md)。
